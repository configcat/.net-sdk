...
public interface IConfigCatInitializer
{
    ...
    /// <exception cref="TimeoutException">One or more clients using Auto Polling mode failed to obtain config data within the configured <c>maxInitWaitTime</c>.</exception>
