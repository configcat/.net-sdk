...
{
    public static FormattableLogMessage Log(this ILogger logger, LogLevel level, LogEventId eventId, string message)
    {
        return Log(logger, level, eventId, exception: null, message);
    }

    public static FormattableLogMessage Log(this ILogger logger, LogLevel level, LogEventId eventId, Exception exception, string message)
    {
        if (logger is null)
        {
    ...
    public static FormattableLogMessage LogFormatted(this ILogger logger, LogLevel level, LogEventId eventId, string messageFormat, string[] argNames, object[] argValues)
    {
        return LogFormatted(logger, level, eventId, exception: null, messageFormat, argNames, argValues);
    }

    public static FormattableLogMessage LogFormatted(this ILogger logger, LogLevel level, LogEventId eventId, Exception exception, string messageFormat, string[] argNames, object[] argValues)
    {
        if (logger is null)
        {
            throw new ArgumentNullException(nameof(logger));
    ...
    public static FormattableLogMessage LogInterpolated(this ILogger logger, LogLevel level, LogEventId eventId, FormattableString message, params string[] argNames)
    {
        return LogInterpolated(logger, level, eventId, exception: null, message, argNames);
    }

    public static FormattableLogMessage LogInterpolated(this ILogger logger, LogLevel level, LogEventId eventId, Exception exception, FormattableString message, params string[] argNames)
    {
        if (logger is null)
        {
            throw new ArgumentNullException(nameof(logger));
